...
def mainlist_series(item):
    ...
    itemlist.append(item.clone( title = 'Capítulos', action = 'list_all', url = host + '/series-3/capitulos/', search_type = 'tvshow' ))
...
def list_all(item):
    ...
    for url, thumb, in matches:
        ...
        if item.search_type == 'movie':
            ...
            if "1a Temporada" in title: SerieName = title.split("1a Temporada")[0]
            elif "2a Temporada" in title: SerieName = title.split("2a Temporada")[0]
            elif "3a Temporada" in title: SerieName = title.split("3a Temporada")[0]
            elif "4a Temporada" in title: SerieName = title.split("4a Temporada")[0]
            elif "5a Temporada" in title: SerieName = title.split("5a Temporada")[0]
            elif "1a temporada" in title: SerieName = title.split("1a temporada")[0]
            elif "2a temporada" in title: SerieName = title.split("2a temporada")[0]
            elif "3a temporada" in title: SerieName = title.split("3a temporada")[0]
            elif "4a temporada" in title: SerieName = title.split("4a temporada")[0]
            elif "5a temporada" in title: SerieName = title.split("5a temporada")[0]
...
def list_search(item):
    ...
    for url, title, type in matches:
        ...
        if search_type == 'tvshow':
            ...
            elif "1ª Temporada" in title: SerieName = title.split("1ª Temporada")[0]
            elif "2ª Temporada" in title: SerieName = title.split("2ª Temporada")[0]
            elif "3ª Temporada" in title: SerieName = title.split("3ª Temporada")[0]
            elif "4ª Temporada" in title: SerieName = title.split("4ª Temporada")[0]
            elif "5ª Temporada" in title: SerieName = title.split("5ª Temporada")[0]
            elif "1ª temporada" in title: SerieName = title.split("1ª temporada")[0]
            elif "2ª temporada" in title: SerieName = title.split("2ª temporada")[0]
            elif "3ª temporada" in title: SerieName = title.split("3ª temporada")[0]
            elif "4ª temporada" in title: SerieName = title.split("4ª temporada")[0]

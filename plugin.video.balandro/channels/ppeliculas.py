...
def corregir_servidor(servidor):
     ...
     servidor = servidor.replace('.link', '').replace('.club', '').replace('.red', '').replace('.download', '').replace('.vip', '').replace('.space', '').replace('.name', '').strip()
     servidor = servidor.replace('.xyz', '').replace('.me', '').replace('.one', '').replace('.hu', '')

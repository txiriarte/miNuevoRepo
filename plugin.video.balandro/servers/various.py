...
def get_video_url(page_url, url_referer=''):
    ...
    if xbmc.getCondVisibility('System.HasAddon("script.module.resolveurl")'):
        ...
        if 'tubeload' in page_url: txt_server = 'Tubeload'
        ...
        elif 'terabox' in page_url: txt_server = 'Terabox'
              ...
              page_url = page_url.replace('/hlswish.com/', '/streamwish.to/')
        ...
        elif 'filelions' in page_url or 'azipcdn' in page_url or 'alions' in page_url or 'dlions' in page_url or 'mlions' in page_url or 'fviplions' in page_url or 'javlion' in page_url or 'fdewsdc' in page_url:
        ...
        elif 'lulustream' in page_url or 'luluvdo' in page_url or 'lulu' in page_url or 'ponmi' in page_url:
        ...
        try:
            ...
            if resuelto:
                if '.zip' in resuelto or '.rar' in resuelto:
